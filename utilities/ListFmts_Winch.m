function tblList = ListFmts_Winch()
% Internal function called by WAVE to list all information about all the
% currently known ship winch wire-out file formats. This code is automatically
% extended by the UI in WAVE, so edit carefully.
%
% Returns:
