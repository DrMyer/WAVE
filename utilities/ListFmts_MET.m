function tblList = ListFmts_MET()
% Internal function called by WAVE to list all information about all the
% currently known ship MET (meteorological) file formats. This code is
% automatically extended by the UI in WAVE, so edit carefully.
%
% Returns:
